...
import side_logo from "@/public/assets/cpataralogosidebar.png";
...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar  ">
      <div className="sidebar_content space-y-20 ">
        <div className="sidebar_top ">
          <Image src={side_logo} alt="Cparta Logo" />
        </div>
        <div className="sidebar_links flex  space-y-14 flex-col   ">
          <div>
            <Link
              href={""}
          ...
          <div>
            <Link
              ...
              className={`flex items-center justify-between ${
                isOpen === true
                  ? " rounded-e-3xl border-l-4 text-darkred-color border-darkred-color bg-lightred-color  "
                  : ""
              } p-4 transition ease-in-out duration-300  text-lg font-semibold`}
            ...
            >
              <div className="flex items-center gap-4">
                ...
                >
                  <path
                    ...
                    fill={`${isOpen === true ? "#EE232F" : "#242223"}`}
                  />
                  <path
              ...
              <IoIosArrowDown
                className={`font-bold ${
                  isOpen === true ? "rotate-0" : "-rotate-90"
                } transition ease-in-out duration-300`}
              />
            </Link>
            {isOpen && (
              <>
                <div className="transition ease-in-out duration-300 drop_list_options flex items-center flex-col space-y-8 justify-center mt-4">
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        fill={`${
                          pathname === "/Home/Profile" ? "#7B7B7B" : "#16151C"
                        }`}
                      />
                    </svg>
                    Profile
                  ...
                  <Link
                    href={""}
                    className="text-text-color flex items-center gap-4"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
